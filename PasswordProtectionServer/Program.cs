...
namespace PasswordProtectionServer
{
    class Program
    {
        ...
        {
            var certificate = Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "localhost.cer");
        ...
        static void ProcessClient(TcpClient client)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Got Messege from client{0}", messageData);
                string response;
                    ...
                    case "05"://Password change request
                        {
                            ...
                            string newPass = matchNewPassword.Groups["newpwd"].Value;
